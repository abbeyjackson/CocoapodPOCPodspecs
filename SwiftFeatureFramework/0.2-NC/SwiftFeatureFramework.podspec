Pod::Spec.new do |s|
  ...
  s.vendored_frameworks = ["SwiftFeatureFramework-iOS-universal/SwiftFeatureFramework.framework", "SwiftFeatureFramework-iOS-universal/NestedCoreFramework.framework"]
